# -*- coding: utf-8 -*-
#
# BCCVL documentation build configuration file, created by
# sphinx-quickstart on Tue Jun 24 10:53:14 2014.
#
...
latex_documents = [
    ('index', 'BCCVL.tex', u'BCCVL Documentation',
...
man_pages = [
    ('index', 'bccvl', u'BCCVL Documentation',
     [u'Author Name'], 1)
]
...
texinfo_documents = [
    ('index', 'BCCVL', u'BCCVL Documentation',
     u'Author Name', 'BCCVL', 'One line description of project.',
     'Miscellaneous'),
]
...
# custom tag to include Todo list as separate page
if todo_include_todos:
    tags.add('todolist')  # noqa

plantuml = 'java -jar plantuml.jar'
file_insertion_enabled = True

# html_style= 'my_styles.css'
